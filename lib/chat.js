...
var Chat = (function(){
	...
	Chat.prototype.join = function(channel, joined){
		...
		var _this = this;
		https.get({
			"method": "GET", "host": "api.twitch.tv", "path": "/kraken/chat/"+channel+"/badges?client_id="+encodeURIComponent(client_id),
		...
		https.get({
			"method": "GET", "host": "api.twitch.tv", "path": "/kraken/chat/"+channel+"/emoticons?client_id="+encodeURIComponent(client_id),
			"headers": { "Accept": "application/vnd.twitchtv.v3+json" }
		}, function(resp){
			var data = "";
			resp.on("data", function(chunk){
	...
	Chat.prototype.joinWhisper = function(user){
		...
		var _this = this;
		https.get({
			"method": "GET", "host": "api.twitch.tv", "path": "/kraken/chat/"+user+"/emoticons?client_id="+encodeURIComponent(client_id),
			"headers": { "Accept": "application/vnd.twitchtv.v3+json" }
		}, function(resp){
			var data = "";
			resp.on("data", function(chunk){
	...
	Chat.prototype.refreshStatus = function(channel, cb){
		var _this = this;
		https.get({
			"method": "GET", "host": "api.twitch.tv", "path": "/kraken/streams/"+channel+"?client_id="+encodeURIComponent(client_id),
			"headers": { "Accept": "application/vnd.twitchtv.v3+json" }
		}, function(resp){
			var data = "";
			resp.on("data", function(chunk){
