...
var loadHighlights = function(fillTable){
	...
	var h = [];
	if(typeof(window.localStorage.highlights) != "undefined")
		var h = JSON.parse(window.localStorage.highlights);
...
var saveHighlights = function(){
	window.localStorage.highlights = "";
	var h = [];
	...
	window.localStorage.highlights = JSON.stringify(h);
};
