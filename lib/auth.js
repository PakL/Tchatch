...
let Auth = function(){
	...
	this.needscope = ["chat_login", "user_subscriptions", "user_read", "channel_read", "channel_editor", "channel_commercial"];
	this.token = "";
	this.userinfo = [];
...
Auth.prototype.logout = function() {
	...
	document.querySelector("#start_greeting").innerText = "Hallo Gast! Ohne einzuloggen kannst du hier zwar Streams gucken, aber um Tchatch in vollen Zügen nutzen zu können solltest du dich einloggen.";
