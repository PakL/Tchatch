...
var startlogin = function() {
	...
	var login = gui.Window.open('https://api.twitch.tv/kraken/oauth2/authorize?response_type=token&amp;client_id='+encodeURIComponent(client_id)+'&amp;redirect_uri='+encodeURIComponent(redirect)+'&amp;scope=chat_login+user_read', {
